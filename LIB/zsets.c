...
int zCSClumC(csptr amat, iluptr mat, int rsa )
{
  /*----------------------------------------------------------------------
  ...
  for( i = 0; i < n; i++ ) {
    if( rsa == 2 ) {
      ...
      L->ma[i] = (complex double *)Malloc( nnz*sizeof(complex double), "CSClum2" );
      L->nzcount[i] = 0;
      U->ja[i] = (int *)Malloc( nnz*sizeof(int), "CSClum3" );
      U->ma[i] = (complex double *)Malloc( nnz*sizeof(complex double), "CSClum4" );
      U->nzcount[i] = 0;
    } else {
      nnz = L->nzcount[i];
      L->ja[i] = (int *)Malloc( nnz*sizeof(int), "CSClum4" );
      L->ma[i] = (complex double *)Malloc( nnz*sizeof(complex double), "CSClum5" );
      L->nzcount[i] = 0;
      nnz = U->nzcount[i];
      U->ja[i] = (int *)Malloc( nnz*sizeof(int), "CSClum6" );
      U->ma[i] = (complex double *)Malloc( nnz*sizeof(complex double), "CSClum7" );
      U->nzcount[i] = 0;
    }
  }
  for( col = 0; col < n; col++ ) {
